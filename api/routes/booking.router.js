...
const { getOneBooking, getAllBookings, createBooking, createMyBooking, updateBooking, deleteBooking, getMyBookings, updateMyBooking, deleteBookings, deleteMyBooking } = require('../controllers/booking.controller')
...
router.post('/', checkAuth, createMyBooking)
